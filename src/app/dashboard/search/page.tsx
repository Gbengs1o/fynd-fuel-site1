                ...
                <div className="max-w-3xl mx-auto space-y-4">
                    <div className="flex gap-3">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 px-4 py-3 rounded-2xl bg-gradient-to-br from-[#3B0764] to-[#5C0CA7] text-white shadow-lg hover:shadow-xl transition-all hover:scale-105 active:scale-95 whitespace-nowrap font-medium"
                        >
